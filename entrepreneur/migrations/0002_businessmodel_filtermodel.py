# Generated by Django 2.2 on 2021-04-20 08:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(choices=[('business sale', 'Business sale'), ('idea and development', 'Idea and developments'), ('industries', 'Industries'), ('investment size', 'Investment size')], default='1', max_length=20)),
            ],
            options={
                'verbose_name': 'filter',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='business', to='entrepreneur.FilterModel')),
            ],
            options={
